...
public class PoiSearchActivity extends FragmentActivity implements OnGetPoiSearchResultListener, OnGetSuggestionResultListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        confirm = (Button)findViewById(R.id.btn_address_confirm);
    ...
    public void onGetPoiDetailResult(PoiDetailResult result) {
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            ...
            address = result.getName() + ": " + result.getAddress();
            Toast.makeText(PoiSearchActivity.this, address, Toast.LENGTH_SHORT)
                    .show();
        }
    }
